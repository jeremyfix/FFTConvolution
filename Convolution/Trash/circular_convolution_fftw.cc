// Compile with g++ -o circular_convolution_fftw circular_convolution_fftw.cc `pkg-config --libs --cflags fftw3` -lX11 -lpthread -O3 -Wall
...
void circular_convolution_fft_fftw(double * src, int h_src, int w_src, double * kernel, int h_kernel, int w_kernel, double * dst)
{   
...
int main(int argc, char * argv[])
{
    ...
    circular_convolution_fft_fftw(src, h_src, w_src,kernel, h_kernel, w_kernel, dst);
